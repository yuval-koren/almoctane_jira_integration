package com.octane.jira.workflow;
...
public class UpdateOctaneFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public UpdateOctaneFactory(WorkflowManager workflowManager) {
