package ut.com.octane.jira.workflow;

import com.octane.jira.workflow.UpdateOctane;
...
public class UpdateOctaneTest
{
    public static final String MESSAGE = "my message";

    protected UpdateOctane function;
